...
var Yammer = function (userEmail, consumerKey, consumerSecret, authorizeCallback) {
	...
	if (fs.existsSync(this.profileDir() + '/oauth/access_tokens.json')) {
...
Yammer.prototype.messageIsUnread = function (message) {
	return !fs.existsSync(this.profileDir() + '/messages/message_' + message.id() + '.json');
};
...
Yammer.prototype.loadThreads = function () {
	...
	if (fs.existsSync(this.profileDir() + '/threads')) {
...
Yammer.prototype.message = function (messageId) {
	...
	if (fs.existsSync(path.join(this.profileDir(), 'messages'))) {
		if (fs.existsSync(path.join(this.profileDir(), 'messages', 'message_' + messageId + '.json'))) {
